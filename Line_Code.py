# -*- coding: utf-8 -*-
"""
Created on Tue Dec  1 11:53:33 2020
DIP Project Line function
@author: CRZUMMALLEN
"""
import numpy as np
import cv2 as cv
...
cue = [200,900]
vect = [0.707107,-0.707107]   #vect = [vx,vy,cue_x,cue_y]
slope = vect[1]/vect[0]
r = 40 #Ball radius. Not sure what units but doesn't matter all that much

#and given a variety of other balls
balls = [[800,800],[600,400],[400,800],[250,500]]
...
img = cv.imread('BackgroundAvg.png')
cv.circle(img,(cue[0],cue[1]),r,(0,255,255),3)
...
for i in range(0,len(balls)):
    ...
    if norm_dist < 2*r:
        ...
        #~~~~
        cv.line(img,(line[2],line[3]),(int(line[2]+line[0]*1000),int(line[3]+line[1]*1000)),(255,0,255),2)
        cv.circle(img,(int(impact[0]),int(impact[1])),r,(0,255,255),3)
        cv.line(img,(cue[0],cue[1]),(int(impact[0]),int(impact[1])),(0,255,255),2)
        
    #~~~~
    cv.circle(img,(balls[i][0],balls[i][1]),r,(0,255,0),3)

cv.imshow('pool table',img)         